...
export class SPBHeaderDecoder {

    private static defaultHeaderSize: number = 588;
    ...
    constructor (headerBuffer:Buffer) {
        this.headerSize             = headerBuffer.readIntBE(0,2);
    ...
    public static getHeaderSize():number {
        return SPBHeaderDecoder.defaultHeaderSize;
    }
    ...
    private validate():void {
         ...
         */
         if(this.headerSize !== SPBHeaderDecoder.defaultHeaderSize) {
            throw new ProtocolException(ProtocolError.EGEN9901);
         }
         if(ProtocolVersion[this.protocolVersion] == null ) {
            throw new ProtocolException(ProtocolError.EGEN9902);
         }
         if(CryptAlgType[this.assymetricAlgType] == null ) {
            throw new ProtocolException(ProtocolError.EGEN9903);
         }
         if(ContentEncryptionType[this.symetricAlgType] == null ) {
            throw new ProtocolException(ProtocolError.EGEN9904);
         }
         if(CryptAlgType[this.localAssymetricAlgType] == null ) {
            throw new ProtocolException(ProtocolError.EGEN9905);
         }
         if(HashAlg[this.hashAlg] == null ) {
            throw new ProtocolException(ProtocolError.EGEN9906);
         }
    }
